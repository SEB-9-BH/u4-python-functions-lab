...
def apply_discount(price, discount_percentage):
    """Apply a discount to a price and return the new price."""
...
def product(*args):
    """Calculate the product of an arbitrary number of arguments."""
    if not args:
        return 0
...
# Additional test cases to verify all functions work correctly
print("\n=== Additional Test Cases ===")
print('Triangle area (7, 3):', calculate_area_triangle(7, 3))
print('Simple interest (1500, 3.5, 5):', simple_interest(1500, 3.5, 5))
print('Apply discount (80, 10):', apply_discount(80, 10))
print('Sum to 10:', sum_to(10))
print('Largest (10, 4, 2):', largest(10, 4, 2))
print('Product (-1, 4):', product(-1, 4))
print('Calculator (10, 5, "add"):', basic_calculator(10, 5, "add"))
print('Calculator (10, 5, "multiply"):', basic_calculator(10, 5, "multiply"))
print('Calculator (10, 5, "divide"):', basic_calculator(10, 5, "divide"))
